...
if (!gg) {
  gg = "6281256300528,6285175363668";   // You can Change this number //
}
...
global.mongodb = process.env.MONGODB || "mongodb+srv://mikukawaii:MhDfOdN0k8uCpYri@cluster0.9g5orpj.mongodb.net/?retryWrites=true&w=majority";
global.sessionId = process.env.SESSION_ID || "ok";
global.prefa = process.env.PREFIX || "-";
global.tenorApiKey =
  process.env.TENOR_API_KEY || "AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c";
global.packname = process.env.PACKNAME || `Moch Danu Hidayat`;
global.author = process.env.AUTHOR || "by: Schizophree";
